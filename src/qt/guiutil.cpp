...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("HC"))
        return false;
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "HC.lnk";
}
...
{
    return GetAutostartDir() / "HC.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("HC-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  HC-qt [" + tr("command-line options") + "]                     " + "\n";
